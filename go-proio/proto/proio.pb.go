...
type BucketHeader_PayloadType int32

const (
	BucketHeader_EVENTS BucketHeader_PayloadType = 0
	BucketHeader_FOOTER BucketHeader_PayloadType = 1
)

var BucketHeader_PayloadType_name = map[int32]string{
	0: "EVENTS",
	1: "FOOTER",
}
var BucketHeader_PayloadType_value = map[string]int32{
	"EVENTS": 0,
	"FOOTER": 1,
}

func (x BucketHeader_PayloadType) String() string {
	return proto1.EnumName(BucketHeader_PayloadType_name, int32(x))
}
func (BucketHeader_PayloadType) EnumDescriptor() ([]byte, []int) {
...
type BucketHeader struct {
	...
	Type            BucketHeader_PayloadType `protobuf:"varint,4,opt,name=type,proto3,enum=proio.proto.BucketHeader_PayloadType" json:"type,omitempty"`
	FileDescriptors [][]byte                 `protobuf:"bytes,5,rep,name=fileDescriptors" json:"fileDescriptors,omitempty"`
	MetaData        []*Meta                  `protobuf:"bytes,6,rep,name=metaData" json:"metaData,omitempty"`
}
...
func (m *BucketHeader) GetType() BucketHeader_PayloadType {
	if m != nil {
		return m.Type
	}
...
func init() {
	...
	proto1.RegisterEnum("proio.proto.BucketHeader_PayloadType", BucketHeader_PayloadType_name, BucketHeader_PayloadType_value)
}
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= (BucketHeader_PayloadType(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorProio = []byte{
	...
	,
}
